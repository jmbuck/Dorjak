...
function update() 
{
	...
	for(asteroid in asteroids) {
		asteroidsData.push({x: asteroid.asteroid.bodyDef.position.x, y: asteroid.asteroid.bodyDef.position.y, radius: asteroid.asteroid.fixtureDef.shape.GetRadius(), id: asteroid.id});
	}
	var planetsData = [];
